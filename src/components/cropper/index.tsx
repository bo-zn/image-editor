...
export default defineComponent({
  ...
  setup(props, { expose }) {
    ...
    const mouseMove = (e: MouseEvent) => {
      ...
      selectPosi = handleMouseInfo(tempCursorIndex !== null ? tempCursorIndex : cursorIndex, selectPosi, {
        x: distanceX,
        y: distanceY
      })
      selectPosi = checkSelectBoundary(initSize.width, initSize.height, selectPosi)
    ...
    return () => (
      <div>
        <canvas ref={canvasRef} onMouseup={mouseUp} onMousemove={mouseMove} onMousedown={mouseDown} />
      </div>
    )
  }
})
